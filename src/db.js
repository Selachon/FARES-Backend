...
let mem = {
  users: [
    ...
    {
      username: "surgas.compras",
      password: "1234",
      role: "USER",
      empresa: "SURGAS",
    },
    {
      username: "surgas.logistica",
      password: "1234",
      role: "USER",
      empresa: "SURGAS",
    },
  ...
  certificates: [
    {
      ...
      resultado: "CUMPLE",
      empresa: "SURGAS",
      assignedUsers: ["surgas", "surgas.compras"],
      links: { informes: "#", formatos: "#", certificados: "#" },
    },
    {
      numCert: 1002,
      serial: "Z9Y8X7",
      fechaCargue: new Date(Date.now() - 86400000 * 2),
      resultado: "NO CUMPLE",
      empresa: "SURGAS",
      assignedUsers: ["surgas.logistica"],
      links: { informes: "#", formatos: "#", certificados: "#" },
    },
    {
      numCert: 1003,
      serial: "QW12ER",
      fechaCargue: new Date(Date.now() - 86400000 * 4),
      resultado: "CUMPLE",
      empresa: "CHILCO",
      assignedUsers: ["chilco"],
      links: { informes: "#", formatos: "#", certificados: "#" },
    },
  ],
};
  ...
  return {
    ...
    findOne(query) {
      return Promise.resolve(
        mem[name].find((u) => u.username === query.username) || null
      );
    },
    insertOne(doc) {
      mem[name].push(doc);
      return Promise.resolve({ insertedId: doc.numCert || doc.username });
    },
    insertMany(docs) {
      mem[name].push(...docs);
    ...
    countDocuments() {
      return Promise.resolve(mem[name].length);
    },
  };
}
// --- FIN MODO MEMORIA ---
